...
void exportProblem(py::module& m)
{
    ...
    auto set_he  = [](Problem& self, ConstraintFunction4py  he) { self.he  = convert(he); };
    auto set_hg  = [](Problem& self, ConstraintFunction4py  hg) { self.hg  = convert(hg); };
    auto set_v   = [](Problem& self, ConstraintFunction4py   v) { self.v   = convert(v);  };
    auto set_f   = [](Problem& self, ObjectiveFunction4py    f) { self.f   = convert(f);  };
