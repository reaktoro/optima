...
void exportProblem(py::module& m)
{
    py::class_<Problem>(m, "Problem")
        ...
        .def_readwrite("Aex", &Problem::Aex)
        .def_readwrite("Aep", &Problem::Aep)
        .def_readwrite("Agx", &Problem::Agx)
        .def_readwrite("Agp", &Problem::Agp)
        .def_readwrite("be", &Problem::be)
        .def_readwrite("bg", &Problem::bg)
        .def_readwrite("he", &Problem::__4py_he)
        .def_readwrite("hg", &Problem::__4py_hg)
        .def_readwrite("v", &Problem::__4py_v)
        ...
        .def_readwrite("fxw", &Problem::fxw)
        .def_readwrite("bw", &Problem::bw)
        .def_readwrite("hw", &Problem::hw)
        .def_readwrite("vw", &Problem::vw)
        ;
}
