...
void exportStructure(py::module& m)
{
    py::class_<Structure>(m, "Structure")
        .def_readwrite("A", &Structure::A, "The coefficient matrix A of the linear equality constraints.")
        ...
        .def("numVariables", &Structure::numVariables, py::return_value_policy::reference_internal, "Return the number of variables.")
        .def("numEqualityConstraints", &Structure::numEqualityConstraints, py::return_value_policy::reference_internal, "Return the number of linear equality constraints.")
