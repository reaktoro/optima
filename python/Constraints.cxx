...
void exportConstraints(py::module& m)
{
    py::class_<Constraints>(m, "Constraints")
        ...
        .def("setEqualityConstraintMatrix", &Constraints::setEqualityConstraintMatrix, "Set the equality constraint matrix Ae.")
        .def("setInequalityConstraintMatrix", &Constraints::setInequalityConstraintMatrix, "Set the inequality constraint matrix Ai.")
        ...
        .def("numEqualityConstraints", &Constraints::numEqualityConstraints, "Return the number of linear equality constraints.")
        .def("numInequalityConstraints", &Constraints::numInequalityConstraints, "Return the number of linear inequality constraints.")
