...
void exportResult(py::module& m)
{
    py::class_<Result>(m, "Result")
        ...
        .def_readwrite("num_objective_evals_g", &Result::num_objective_evals_g)
        .def_readwrite("num_objective_evals_H", &Result::num_objective_evals_H)
        ...
        .def_readwrite("time_objective_evals_g", &Result::time_objective_evals_g)
        .def_readwrite("time_objective_evals_H", &Result::time_objective_evals_H)
