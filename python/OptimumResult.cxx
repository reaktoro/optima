...
void exportOptimumResult(py::module& m)
{
    py::class_<OptimumResult>(m, "OptimumResult")
        ...
        .def_readwrite("error_optimality", &OptimumResult::.error_optimality)
        .def_readwrite("error_feasibility", &OptimumResult::.error_feasibility)
        .def_readwrite("error_complementarity_lower", &OptimumResult::.error_complementarity_lower)
        .def_readwrite("error_complementarity_upper", &OptimumResult::.error_complementarity_upper)
