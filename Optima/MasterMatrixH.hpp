...
/// Used to represent block matrix \eq{H} in @ref MasterMatrix.
class MasterMatrixH
{
private:
...
public:
    /// Construct a MasterMatrixH instance.
    MasterMatrixH(Index nx, Index np);

    /// Construct a MasterMatrixH instance.
    MasterMatrixH(MatrixConstRef Hxx, MatrixConstRef Hxp);

    /// Construct a copy of a MasterMatrixH instance.
    MasterMatrixH(const MasterMatrixH& other);

    /// Assign a MasterMatrixH instance to this.
    auto operator=(MasterMatrixH other) -> MasterMatrixH& = delete;
