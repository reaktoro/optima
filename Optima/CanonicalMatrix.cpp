...
struct CanonicalMatrix::Impl
{
    ...
    auto update(const MasterMatrix& M) -> void
    {
        ...
        error(nbu > 0, "CanonicalMatrix::update failed with given indices of "
...
auto CanonicalMatrix::operator=(CanonicalMatrix other) -> CanonicalMatrix&
{
    pimpl = std::move(other.pimpl);
    return *this;
}

auto CanonicalMatrix::update(const MasterMatrix& M) -> void
{
    pimpl->update(M);
}
