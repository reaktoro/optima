...
void exportSaddlePointMatrix(py::module& m)
{
    py::class_<SaddlePointMatrix>(m, "SaddlePointMatrix")
        ...
        .def("H", &SaddlePointMatrix::H, py::return_value_policy::reference_internal, "Return the Hessian matrix *H*.")
        .def("A", &SaddlePointMatrix::A, py::return_value_policy::reference_internal, "Return the Jacobian matrix *A*.")
        .def("G", &SaddlePointMatrix::G, py::return_value_policy::reference_internal, "Return the matrix *G*.")
        ...
        .def("matrix", &SaddlePointMatrix::matrix, "Convert this SaddlePointMatrix instance into a numpy.ndarray instance.")
        ;
    ...
    py::class_<SaddlePointVector>(m, "SaddlePointVector")
        ...
        .def("a", &SaddlePointVector::a, py::return_value_policy::reference_internal, "Return the solution vector *a*.")
        .def("b", &SaddlePointVector::b, py::return_value_policy::reference_internal, "Return the solution vector *b*.")
        .def("vector", &SaddlePointVector::vector, "Convert this SaddlePointVector instance into a numpy.ndarray instance.")
        ;
    ...
    py::class_<SaddlePointSolution>(m, "SaddlePointSolution")
        ...
        .def("x", &SaddlePointSolution::x, py::return_value_policy::reference_internal, "Return the solution vector *x*.")
        .def("y", &SaddlePointSolution::y, py::return_value_policy::reference_internal, "Return the solution vector *y*.")
        .def("vector", &SaddlePointSolution::vector, "Convert this SaddlePointSolution instance into a numpy.ndarray instance.")
        ;
}
