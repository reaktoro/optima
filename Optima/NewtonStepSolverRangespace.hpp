...
class NewtonStepSolverRangespace
{
public:
    /// Construct a NewtonStepSolverRangespace instance.
    NewtonStepSolverRangespace(Index nx, Index np, Index ny, Index nz);

    /// Construct a copy of a NewtonStepSolverRangespace instance.
    NewtonStepSolverRangespace(const NewtonStepSolverRangespace& other);

    /// Destroy this NewtonStepSolverRangespace instance.
    virtual ~NewtonStepSolverRangespace();

    /// Assign a NewtonStepSolverRangespace instance to this.
    auto operator=(NewtonStepSolverRangespace other) -> NewtonStepSolverRangespace&;
