...
class NewtonStepSolverNullspace
{
public:
    /// Construct a NewtonStepSolverNullspace instance.
    NewtonStepSolverNullspace(Index nx, Index np, Index ny, Index nz);

    /// Construct a copy of a NewtonStepSolverNullspace instance.
    NewtonStepSolverNullspace(const NewtonStepSolverNullspace& other);

    /// Destroy this NewtonStepSolverNullspace instance.
    virtual ~NewtonStepSolverNullspace();

    /// Assign a NewtonStepSolverNullspace instance to this.
    auto operator=(NewtonStepSolverNullspace other) -> NewtonStepSolverNullspace&;
