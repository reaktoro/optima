...
#include "NewtonStepSolverNullspace.hpp"
...
struct NewtonStepSolverNullspace::Impl
{
    ...
    auto compute(const JacobianMatrix& J, const ResidualVector& F, CanonicalVectorRef dus) -> void
    {
        ...
        dus.xs << dxbe, dxbi, dxns;
        dus.p = dp;
        dus.wbs << dwbe, dwbi;
    }
};

NewtonStepSolverNullspace::NewtonStepSolverNullspace(Index nx, Index np, Index ny, Index nz)
: pimpl(new Impl(nx, np, ny, nz))
{}

NewtonStepSolverNullspace::NewtonStepSolverNullspace(const NewtonStepSolverNullspace& other)
: pimpl(new Impl(*other.pimpl))
{}

NewtonStepSolverNullspace::~NewtonStepSolverNullspace()
{}

auto NewtonStepSolverNullspace::operator=(NewtonStepSolverNullspace other) -> NewtonStepSolverNullspace&
{
    pimpl = std::move(other.pimpl);
    return *this;
}

auto NewtonStepSolverNullspace::decompose(const JacobianMatrix& M) -> void
{
    pimpl->decompose(M);
}

auto NewtonStepSolverNullspace::compute(const JacobianMatrix& J, const ResidualVector& F, CanonicalVectorRef dus) -> void
{
