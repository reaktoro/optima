...
MasterVector::MasterVector(Index nx, Index np, Index ny, Index nz)
...
MasterVector::MasterVector(const MasterVector& other)
...
auto MasterVector::operator=(MasterVector other) -> MasterVector&
{
