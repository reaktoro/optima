...
def test_jacobian_block_w(nx, np, ny, nz, nl):
    ...
    assert_allclose(Ax, W.Ax)
    assert_allclose(Ap, W.Ap)
    assert_allclose(Jx, W.Jx)
    assert_allclose(Jp, W.Jp)
    assert_allclose(Wx, W.Wx)
    assert_allclose(Wp, W.Wp)
    ...
    assert_almost_equal(Ibb, Rb @ Wx[:, jb])
    assert_almost_equal(Sbn, Rb @ Wx[:, jn])
    assert_almost_equal(Sbp, Rb @ Wp)
