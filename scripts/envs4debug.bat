...
set PYTHONPATH=%CD%\python\package\installed\Debug\Lib\site-packages;%CD%\python\package\installed\Lib\site-packages;%OPTIMA_BACKUP_PYTHONPATH%
set PATH=%CD%\Optima\Debug;%CD%\Optima;%OPTIMA_BACKUP_PATH%
